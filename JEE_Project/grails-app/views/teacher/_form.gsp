...
<div class="fieldcontain ${hasErrors(bean: teacherInstance, field: 'mdp', 'error')} ">
	<label for="mdp">
		<g:message code="teacher.mdp.label" default="Mdp" />
		
	</label>
	<g:textField name="mdp" value="${teacherInstance?.mdp}"/>
</div>
